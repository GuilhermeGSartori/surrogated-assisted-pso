...
mkdir -p "$RUN_DIR/${SCRIPT_BASE}_hybrid"
mkdir -p "$OUTPUT_DIR"
...
./surrogated-assisted-optimizer pso 11 0 10 0.8 1.1 1.8
...
./surrogated-assisted-optimizer pso 11 1 10 0.8 1.1 1.8
...
echo "=== Running optimizer hybrid ==="

./surrogated-assisted-optimizer pso 11 2 10 0.8 1.1 1.8

echo

echo "=== Optimizer with hybrid finished ==="

echo "=== Plotting nodes ==="

cd "$RUN_DIR"

python3 ../plot.py "$OUTPUT_PLOT_HYBRID"

echo "Plot saved to: $OUTPUT_PLOT_HYBRID"
